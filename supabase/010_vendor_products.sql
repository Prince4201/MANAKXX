...
DROP POLICY IF EXISTS "Vendors can read own documents" ON storage.objects;
...
CREATE INDEX IF NOT EXISTS product_documents_vendor_id_created_at_idx
  ON public.product_documents (vendor_id, created_at DESC);
